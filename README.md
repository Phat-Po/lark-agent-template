...
**🚀 快速安装：** 把 [安装引导 Prompt](docs/onboarding-prompt.zh.md) 粘贴到任何 AI 助手中，自动引导你完成每一步。

**📋 飞书应用配置：** [完整配置清单](docs/feishu-app-setup.zh.md)（权限列表、事件订阅、发布上线）
...
| 文档 | 内容 |
|------|------|
| [docs/onboarding-prompt.zh.md](docs/onboarding-prompt.zh.md) | **粘贴到任何 AI 助手中**，获得一步步的安装引导 |
| [docs/feishu-app-setup.zh.md](docs/feishu-app-setup.zh.md) | 飞书应用创建、权限列表、事件订阅、发布上线 |
| [docs/architecture.zh.md](docs/architecture.zh.md) | 消息流、Agent 循环、Harness、记忆、卡片 |
| [docs/adding-tools.zh.md](docs/adding-tools.zh.md) | 用 `@register_tool` 构建自定义工具 |
| [docs/deploy-local-docker.zh.md](docs/deploy-local-docker.zh.md) | 用 Docker Compose 在本机运行 |
| [docs/deploy-vps.zh.md](docs/deploy-vps.zh.md) | 部署到 Linux VPS 实现 24/7 运行 |
